...
public class Stage05 : MonoBehaviour
{
    ...
    {
        if (EventSystem.current.currentSelectedGameObject.tag == "DesertAnimals" && Click == false)
        {
        ...
        if (EventSystem.current.currentSelectedGameObject.tag != "CorrectAnimal" && EventSystem.current.currentSelectedGameObject.tag != "DesertAnimals" && Click == false)
        {
            Click = true;
